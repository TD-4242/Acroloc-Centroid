...
BUTTONS = [
    ...
    dict(name='x1', row=7, col=1, lines=['X1']),
    dict(name='x10', row=8, col=1, lines=['X10']),
    dict(name='x100', row=9, col=1, lines=['X100']),
    dict(name='mpg', row=10, col=1, lines=[], icon='wheel'),
    dict(name='y_positive', row=6, col=3, lines=['+Y'], icon='up',
         text_y=[79]),
    dict(name='z_positive', row=6, col=5, lines=['+Z'], icon='up',
         text_y=[79]),
    dict(name='x_negative', row=7, col=2, lines=['-X'], icon='left',
         text_y=[79]),
    dict(name='tortoise_hare', row=7, col=3, lines=[], icon='hare',
         icon_on='tortoise'),
    dict(name='x_positive', row=7, col=4, lines=['+X'], icon='right',
         text_y=[79]),
    dict(name='y_negative', row=8, col=3, lines=['-Y'], icon='down',
         text_y=[52]),
    dict(name='z_negative', row=8, col=5, lines=['-Z'], icon='down',
         text_y=[52]),
