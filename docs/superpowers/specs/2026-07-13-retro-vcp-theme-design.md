...
| 5-6 | CLNT MODE knob (2x2, cols 1-2); FLOOD M8 (5,3) over PUMP (6,3), regular 1x1 buttons. PUMP lights on the real pump output OUT4 (on for any reason) and its PLC latch (`PumpManual_M`) toggles in either coolant mode |
