...
| 9 | SINGLE BLOCK (9,2) |
| 10 | TOOL CHECK (10,6) |
| 11 | CYCLE START (11,1) / CYCLE CANCEL (11,2) / FEED HOLD (11,3); RAPID 25% toggle (11,5) — **REMOVED 2026-08-06**, cell now empty. `SV_PLC_RAPID_FEEDRATE_OVERRIDE` was measured to scale G1 as well as G0 and to bypass CNC12's G74/G84 override lockout; see [2026-08-05-rapid-override-g0-only-design.md](2026-08-05-rapid-override-g0-only-design.md) |
